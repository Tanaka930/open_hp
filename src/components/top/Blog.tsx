...
export default function blog(props:Props){
  ...
  if(isMobileSite){
    // スマホ処理
    blogHeight = Number(blogCount) * 280 + 250;
  }else{
    // pc処理
    ...
    <>
      ...
      <section className="">
        <div className="body-font">
          ...
          <div className="container px-5 pt-3 md:pt-0 pb-12 md:pb-24 max-w-7x1">
                  ...
                  <UnstyledLink href={`/blog/${content.id}`} >
                    <div className="pt-2 pb-4 px-2 rounded-lg cursor-pointer">
                      ...
                      <h3 className="tracking-widest text-dayColor text-sm md:text-xs font-medium mt-8 mb-2">
                        ...
                        <span className="mx-4 px-1 md:px-2 bg-yellow-500 text-white py-0.5">

  ...
  return(
    ...
    <section className='bg-gray-50 h-auto mx-6'>
      <div className="md:mx-36">
        <h2 className='text-4xl md:text-7xl w-full pb-10 text-left'>SERVICE</h2>
        <h3 className='text-xl md:text-3xl w-full pb-10 text-left font-bold text-green-700'>- 事業内容 -</h3>

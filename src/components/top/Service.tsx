...
export default function Service(props:Props){
  ...
  return(
    ...
    <section className='bg-gray-50 h-auto'>
      <div className="">
        <h2 className='text-4xl md:text-5xl w-full pb-4 text-center'>SERVICE</h2>
        <h3 className='text-xl md:text-2xl w-full pb-8 xl:pb-16 text-center font-bold text-green-700 font-YuGothic'>ー 事業内容 ー</h3>

              ...
              <div className="tab-content tab-space">
                ...
                <div className={openTab === 1 ? 'block' : 'hidden'} id="link1">
                  ...
                  <div className="px-4 pb-12 md:w-2/3 md:mx-auto">
                    <p>
                      多くの情報やモノが混在する社会では、IT化による既存のプロセスの変革が必要不可欠となります。<br />
                      その複雑化された社会でも全ての始まりは人であり、それぞれの個性や異なった価値観、また同時に強みや弱みを持ち、互いに“個性“を認め合い尊重することで共存できるものです。<br />
                      しかし社会に生きる大部分はルールや慣習といった“常識“で縛られ、真価を<br />
                      そして人は生まれながらにして自由であるように、人がその社会の中で自由を求めることは至極当然なものです。
                    </p>
                  </div>
                </div>

      ...
      <div className="max-w-screen-xl mx-auto pt-10">
        ...
        <main className="mt-10">
          <div className="block md:flex md:space-x-2 lg:p-0">
            ...
            {/* <a className="w-full md:w-1/3 relative rounded h-96" 
              href="./blog.html"
            >
              <div className="absolute left-0 top-0 w-full h-full z-5 image2">
              </div>
              <style jsx>{`
                .image2 {
                  background-image: linear-gradient(180deg,transparent,rgba(0,0,0,.7));
          ...
          <div className="block lg:flex lg:space-x-2 lg:p-0 mt-10 mb-10">
            ...
            <div className="w-full lg:w-2/3">
              ...
              <div className="rounded w-full lg:flex mb-10">
                <div className="h-48 lg:w-48 flex-none bg-cover text-center overflow-hidden opacity-75 image4"
                  title="deit is very important">
                </div>
                <style jsx>{`
                  .image4 {
              ...
              <div className="rounded w-full lg:flex mb-10">
                <div className="h-48 lg:w-48 flex-none bg-cover text-center overflow-hidden opacity-75 image5"
                  title="deit is very important">
                </div>
                <style jsx>{`
                  .image5 {
